...
const createMenuPage = () => {
  ...
  const imagesArraySrc = ['./images/gumbo-shrimp.jpg', './images/shellfish-stew.jpg', './images/prawn-crayfish-cocktail.jpg', './images/Roasted-Leg-of-Lamb.jpg', './images/Lamb-Ribs.jpg', './images/Pineapple-Shrimp-Rice-Noodle-recipe.jpg', './images/spaghettis_a_la_mariniere.jpg', './images/chateauneuf-du-pape-la-fiole-du-pape.png', './images/Louis Latour Pinot Noir.jpeg', './images/Mouton Cadet, Baron P. De Roths.jpeg', './images/Beaujolais Villages, Georges Duboeuf.jpg'];
  ...
  for (let i = 0; i < 11; i++) {
    const newDivBoxElements = createDivBox({
      ...
      span2Content: span2ContentArray[i],
      h3Element: h3Array[i],
    });
